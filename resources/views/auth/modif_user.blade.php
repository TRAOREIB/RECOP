...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center">{{ __('MODIFIER LE COMPTE D UTILISATEUR') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('updateuser',[$user->id])}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telephone1" type="text" class="form-control @error('telephone1') is-invalid @enderror" name="telephone1" value="{{ $user->telephone1}}" required >
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="service" type="text" class="form-control @error('service') is-invalid @enderror" name="service" value="{{ $user->service}}" required >
