    ...
    <div class="col-sm-12" >
        <div class="col-sm-12 ligneform " style="background-color: #EEE">
            <table class="table table-striped table-condensed" id="table">
                ...
                <tbody>
                   @foreach( $allaccreditation as $accredition)
                    <tr>
                        <td>{{$accredition->titreevenement}}</td>
                        <td>{{$accredition->lieuevenement}}</td>
                        <td>{{$accredition->datedebut}}</td>
                        <td>{{$accredition->datefin}}</td>
                    </tr>
                     @endforeach
