        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class=" row form-group"> 
                    ...
                    <div class="col-sm-8"> 
                        <input type="text" class="form-control" name="titrearticle1" id="designation"  value="{{old('titreaticle')}}">
                ...
                <div class=" row form-group"> 
                    ...
                    <div class="col-sm-8"> 
                        <input type="text" class="form-control" name="themearticle1" id="theme1"  value="{{old('themearticle1')}}">
                ...
                <div class=" row form-group"> 
                    ...
                    <div class="col-sm-4"> 
                        <input type="date" class="form-control" name="datepubarticle1" id="datepubarticle1"  value="{{old('datepubarticle1')}}">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class=" row form-group"> 
                    <label for="titre" class="control-label col-sm-3">Titre <b><i style="color: red">*</i></b></label> 
                    <div class="col-sm-8"> 
                        <input type="text" class="form-control" name="titrearticle2" id="titre2" required="required"  value="{{old('titrearticle2')}}">
                ...
                <div class=" row form-group"> 
                    <label for="theme" class="control-label col-sm-3">Thème <b><i style="color: red">*</i></b></label> 
                    <div class="col-sm-8"> 
                        <input type="text" class="form-control" name="themearticle2" id="themearticle2"  value="{{old('themearticle2')}}" required="required">
                ...
                <div class=" row form-group"> 
                    ...
                    <div class="col-sm-4"> 
                        <input type="date" class="form-control" name="datepubarticle2" id="datepubarticle2" required="required"  value="{{old('datepubarticle2')}}">
