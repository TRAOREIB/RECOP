        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class=" row form-group"> 
                    ...
                    <div class="col-sm-8"> 
                        <input type="text" class="form-control" name="url" id="urlsite"  value="{{$oeuvre->url}}" required="required">
                ...
                <div class=" row form-group"> 
                    ...
                    <div class="col-sm-8">
                        <select class="form-control col-sm-5" name="idgenre">
                            @foreach($genre as $ge)
                            <option value="{{$ge->idgenre}}" <?php if ($oeuvre->idgenre == $ge->idgenre) echo "selected=selected" ?>>{{$ge->genre}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class=" row form-group"> 
                    ...
                    <div class="col-sm-8"> 
                        <input type="text" class="form-control" name="titrearticle1" id="designation"  value="{{$oeuvre->titrearticle1}}" required="required">
                ...
                <div class=" row form-group"> 
                    ...
                    <div class="col-sm-8"> 
                        <input type="text" class="form-control" name="themearticle1" id="theme1"  value="{{$oeuvre->themearticle1}}" required="required">
                ...
                <div class=" row form-group"> 
                    ...
                    <div class="col-sm-8"> 
                        <input type="text" class="form-control" name="url1" id="url1"  value="{{$oeuvre->url1}}" required="required">
                ...
                <div class=" row form-group"> 
                    ...
                    <div class="col-sm-4"> 
                        <input type="date" class="form-control" name="datepubarticle1" id="datepubarticle1"  value="{{$oeuvre->datepubarticle1}}" required="required">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class=" row form-group"> 
                    <label for="titre" class="control-label col-sm-3">Titre <b><i style="color: red">*</i></b></label> 
                    <div class="col-sm-8"> 
                        <input type="text" class="form-control" name="titrearticle2" id="titre2"  value="{{$oeuvre->titrearticle2}}" required="required">
                ...
                <div class=" row form-group"> 
                    <label for="theme" class="control-label col-sm-3">Thème <b><i style="color: red">*</i></b></label> 
                    <div class="col-sm-8"> 
                        <input type="text" class="form-control" name="themearticle2" id="theme"  value="{{$oeuvre->themearticle2}}" required="required">
                ...
                <div class=" row form-group"> 
                    ...
                    <div class="col-sm-8"> 
                        <input type="text" class="form-control" name="url2" id="url1"  value="{{$oeuvre->url2}}" required="required">
                ...
                <div class=" row form-group"> 
                    ...
                    <div class="col-sm-4"> 
                        <input type="date" class="form-control" name="datepubarticle2" id="datepubarticle2"  value="{{$oeuvre->datepubarticle2}}" required="required">
