...
<form class="form-horizontal col-sm-10 offset-2" role="form" method="POST" action="{{ route('informations.update',[$editinformation->idinfo]) }}"  enctype="multipart/form-data" >
