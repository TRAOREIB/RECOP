...
<form method="post" action="{{route('updatecorrespondant')}}" enctype="multipart/form-data">
    {{ csrf_field() }}	
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        ...
                        <label><i>{{$editpjcorrespondant->photo}}</i></label>
                    </div>
                ...
                <input type="hidden" value="{{$editpjcorrespondant->id}}" name="idpj">
                <input type="hidden" value="{{$idcorrespondant}}" name="idcorresp">
