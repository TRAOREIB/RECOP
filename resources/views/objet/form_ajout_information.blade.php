...
@endisset
<p></p>
<form class="col-sm-12" method="post" action="{{route("objet.store")}}" enctype="multipart/form-data" style="margin-top:0px">
    {{ csrf_field() }}
            ...
            <div class="row col-sm-12"> 
                <div id="panneau1" class="col-sm-6">  
                    <div class="card">
                        ...
                        <p></p>
                        <div class="text-danger offset-4">{{$errors->first("numinv", ":message")}}</div>
                        <div class="row form-group">
                            ...
                            <input class="form-control col-sm-6" type='number' value="{{old('numinv')}}" name="numinv" style="margin-left: 10px" >
                        </div>


                        <div class="text-danger">{{$errors->first("photo", ":message")}}</div>
                        <div class="row form-group">
                            <label class="label" style="margin-left: 130px">Photo</label>
                            <input class="form-control col-sm-6" type='file' value="{{old('photo')}}" name="photo" style="margin-left: 10px" >
                        </div>

                        <div class="text-danger offset-4">{{$errors->first("nom", ":message")}}</div>
                        <div class="row form-group">
                            <label class="label" style="margin-left: 120px">Nom</label>
                            <label class="label" style="margin-left: 0px;color: red"><b>&nbsp;*</b></label>
                            <input class="form-control col-sm-6" type='text' value="{{old('nom')}}" name="nom" style="margin-left: 10px" >
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <label class="label" style="margin-left: 0px;color: red"><b>&nbsp;*</b></label>
                            <input class="col-sm-6 form-control" type='text' value="{{old('nonvern')}}" name="nonvern" style="margin-left: 10px">
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <input class="col-sm-6 form-control" type='text' value="{{old('datation')}}" name="datation" style="margin-left: 10px">
                        </div>
                        
                        <div class="row form-group">
                            <label class="label" style="margin-left: 70px">Nom Collecteur</label>
                            <input class="col-sm-6 form-control" type='text' value="{{old('collecteur')}}" name="collecteur" style="margin-left: 10px">
                        </div>
                        
                        <div class="row form-group">
                            <label class="label" style="margin-left: 70px">Nom Detenteur</label>
                            <input class="col-sm-6 form-control" type='text' value="{{old('detenteur')}}" name="detenteur" style="margin-left: 10px">
                        </div>
                         ...
                         <div class="row form-group">
                            ...
                            <select class="form-control col-sm-2" style="margin-left: 10px" name="provenance">
                                <option value="{{old('provenance')}}">Oui</option>
                                <option selected="selected" value="{{old('provenance')}}">Non</option>
                            </select>
                        </div>
                        <div class="row form-group">
                            <label class="label" style="margin-left: 95px">Description</label>
                            <input class="col-sm-6 form-control" type='text' value="{{old('description')}}" name="description" style="margin-left: 10px">
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <input class="col-sm-6 form-control" type='text' value="{{old('usage')}}" name="usage" style="margin-left: 10px">
                        </div>
                        ...
                        <div class="text-danger offset-4">{{$errors->first("localisation", ":message")}}</div>
                        <div class="row form-group">
                            <label class="label" style="margin-left:95px">Localisation</label>
                            <label class="label" style="margin-left: 0px;color: red"><b>&nbsp;*</b></label>
                            <input class="col-sm-6 form-control" type='text' value="{{old('localisation')}}" name="localisation" style="margin-left: 8px">
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <input class="col-sm-7 form-control" type='textarea' value="{{old('observation')}}" name="observation" style="margin-left: 10px">
                        </div>
                ...
                <div id="panneau2" class="row col-sm-6">
                    ...
                    <div class="card col-sm-12" style="">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-danger">{{$errors->first("museedepot", ":message")}}</div>
                            <div class="row form-group">
                            ...
                            <div class="text-danger">{{$errors->first("museeprop", ":message")}}</div>
                            <div class="row form-group">
                    ...
                    <div class="card col-sm-12" style="">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" style="margin-left: 60px">
                                ...
                                <div>
                                    <input type="number" name="poids" value="{{old('poids')}}" step="0.001" class="form-control offset-1 col-sm-10">
                                </div>
                            ...
                            <div class="text-danger">{{$errors->first("typematiere", ":message")}}</div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <input class="col-sm-7 form-control" type='text' value="{{old('technique')}}" name="technique" style="margin-left: 10px">
                            </div>
            ...
            <div class="card col-sm-8" style="">
                ...
                <div class="card-body">
                    ...
                    <table class="dTable col-sm-12" id="tab">
                        ...
                        <div class="text-danger offset-4">{{$errors->first("document", ":message")}}</div>
                        </tbody>
