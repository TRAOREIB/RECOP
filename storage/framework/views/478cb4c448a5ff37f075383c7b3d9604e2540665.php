...
<div class="alert alert-success col-sm-3 offset-4"><label class="offset-1"><?php echo e($message); ?></label></div>
<?php endif; ?>
<form class="form-horizontal col-sm-10" role="form" method="POST" action=" <?php echo e(url('password')); ?>" enctype="multipart/form-data" >
        ...
        <form class="form-horizontal" role="form">
            ...
            <div class=" row form-group"> 
                ...
                <div class="col-sm-5"> 
                    ...
                    <input type="hidden" value="<?php echo e($id); ?>" name="idcandidat" />
...
<?php echo $__env->make('template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GALIAN\resources\views/candidat/form_password.blade.php ENDPATH**/ ?>