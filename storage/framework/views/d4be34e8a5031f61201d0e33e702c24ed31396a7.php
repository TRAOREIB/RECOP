...
<div class="container d-flex flex-row">
    ...
    <div class="card w-50"> 
        ...
        <div class="card-body"> 
            <h4 class="card-title">Accreditation Press</h4> 
            <h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6> 
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> 
            <a href="#" class="btn btn-primary">Lire plus</a> 
        </div>                 
...
<?php echo $__env->make('tprecop.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RECOP\resources\views/accueil/accueil.blade.php ENDPATH**/ ?>