...
<form class="form-horizontal col-sm-10 offset-1" role="form" method="POST" action="<?php echo e(route('modifsujet')); ?>" enctype="multipart/form-data" >
            ...
            <div class="card-footer">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><form method="POST" action="<?php echo e(route('retraitmodifsujet')); ?>">
                                <?php echo e(csrf_field()); ?>
            ...
            <div class="card"> 
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input class="form-control" id="moyentransport" value=' <?php echo e($editaccreditation->moyentransport); ?>' type="text" name="moyentransport"/>
                        </div>
                    </div>
                    <div class="form-group row">
