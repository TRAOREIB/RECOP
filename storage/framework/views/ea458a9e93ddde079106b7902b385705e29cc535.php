...
<b><label>Commentaire sur l'Accreditation N° <?php echo e($idaccreditation); ?></label>

</b>
</div>

<form class="form-horizontal col-sm-10 offset-1" role="form" method="POST" action="<?php echo e(route('ampliateur.store')); ?>" enctype="multipart/form-data">
...
<?php echo $__env->make('tprecop.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RECOP\resources\views/ampliateur/ajout_information.blade.php ENDPATH**/ ?>