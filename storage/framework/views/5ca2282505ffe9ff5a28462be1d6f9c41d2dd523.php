...
<form class="form-horizontal col-sm-10 offset-2" role="form" method="POST" action="<?php echo e(route('information.update',[$editinformation->id])); ?>" enctype="multipart/form-data" >
...
<div class=" row form-group"> 
            ...
            <div class=" row form-group">
                ...
                <div class="col-sm-7" style=""> 
                    <input type="text" class="form-control" name="contenu"  value="<?php echo e($editinformation->contenu); ?>" required="required">
...
</script><?php /**PATH C:\xampp\htdocs\RECOP_ancien\resources\views/information/modif_info.blade.php ENDPATH**/ ?>