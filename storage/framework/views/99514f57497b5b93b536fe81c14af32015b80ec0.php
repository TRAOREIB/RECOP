...
<form class="form-horizontal was-validated col-sm-10 offset-1" role="form" method="POST" action="<?php echo e(route('demandeur.update',[$editdemandeur->iddemandeur])); ?>" enctype="multipart/form-data">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="email" class="form-control" name="email" value="<?php echo e($editdemandeur->mail); ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="numcnib" name="cnib" value="<?php echo e($editdemandeur->cnib); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="numPasseport" name="passeport" value="<?php echo e($editdemandeur->passeport); ?>">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label" for="numPasseport">N° PASSPORT:</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="numPasseport" name="passeport" value="<?php echo e($editdemandeur->passeport); ?>" required>
                        <label><i>Le numéro du passport</i></label>
                    </div>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('tprecop.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RECOP\resources\views/demandeur/modif_demandeur.blade.php ENDPATH**/ ?>