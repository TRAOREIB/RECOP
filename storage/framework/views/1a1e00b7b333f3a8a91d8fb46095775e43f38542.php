...
<body>
	...
	<form class="form-horizontal col-sm-10 offset-2" role="form" method="POST" action="<?php echo e(route('accreditation.store')); ?>" enctype="multipart/form-data" >
...
</html><?php /**PATH C:\xampp\htdocs\RECOP2\resources\views/accreditation/ajout_accreditation.blade.php ENDPATH**/ ?>