...
<form class="form-horizontal col-sm-10 offset-2" role="form" method="POST" action="<?php echo e(route('informations.update',[$editinformation->idinfo])); ?>"  enctype="multipart/form-data" >
   ...
   <!--             <input type="hidden" value="type" name="type">  -->
            ...
            <div class=" row form-group">
                ...
                <div class="col-sm-7" style=""> 
                    <textarea type="textarea" maxlength="2000" class="form-control" name="contenu"  required="required" ><?php echo e($editinformation->contenu); ?></textarea>
...
<?php echo $__env->make('tprecop.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RECOP25\resources\views/information/modif_info2.blade.php ENDPATH**/ ?>