...
<form class="form-horizontal col-sm-10 offset-2" role="form" method="POST" action="<?php echo e(route('informations.store')); ?>" enctype="multipart/form-data" >
        ...
        <div class="col-xs-12 ligneform " style="background-color: #EEE">
            <table class="table table-striped table-condensed" id="table">
                ...
                <tbody>
                     ...
                     <?php $__currentLoopData = $allinformations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $informations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
...
<?php /**PATH C:\xampp\htdocs\RECOP_ancien\resources\views/information/ajout_information.blade.php ENDPATH**/ ?>