...
unset($__errorArgs, $__bag); ?>" id="nom" placeholder="Entrer le nom" name="nom" value="<?php echo e(old('nom')); ?>" required>
                        <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="prenom" placeholder="Entrer le prenom" name="prenom" value="<?php echo e(old('prenom')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="profession" placeholder="Entrer la profession " name="profession" value="<?php echo e(old('profession')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="datenaissance" placeholder="" name="datenaissance" value="<?php echo e(old('datenaissance')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control <?php $__errorArgs = ['lieunaissance'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="lieunaissance" placeholder="Entrer le lieu de naissance " name="lieunaissance" value="<?php echo e(old('lieunaissance')); ?>" required>
                        <?php $__errorArgs = ['lieunaissance'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="nationalite" placeholder=" " name="nationalite" value="<?php echo e(old('nationalite')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="telephone" placeholder=" Entrer le numero de telephone au Burkina Faso " name="telephone" value="<?php echo e(old('telephone')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control <?php $__errorArgs = ['telephoneresidence'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="telephone" placeholder=" Entrer le numero de telephone de votre pays de residence " name="telephoneresidence" value="<?php echo e(old('telephoneresidence')); ?>" required>
                        <?php $__errorArgs = ['telephoneresidence'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" name="mail" value="<?php echo e(old('mail')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control <?php $__errorArgs = ['lieuresidence'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="lieuresidence" placeholder=" " name="lieuresidence" value="<?php echo e(old('lieuresidence')); ?>" required>
                        <?php $__errorArgs = ['lieuresidence'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control <?php $__errorArgs = ['adressepaysresidence'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="adressepaysresidence" value="<?php echo e(old('adressepaysresidence')); ?>" required>
                        <?php $__errorArgs = ['adressepaysresidence'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control <?php $__errorArgs = ['cnib'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="cnib" placeholder="saisir votre numero de carte nationale d'identité " name="cnib" value="<?php echo e(old('cnib')); ?>" required>
                        <?php $__errorArgs = ['cnib'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="date" class="form-control <?php $__errorArgs = ['datedelivcnib'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="datedelivcnib" placeholder=" " name="datedelivcnib" value="<?php echo e(old('datedelivcnib')); ?>" required>
                        <?php $__errorArgs = ['datedelivcnib'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="date" class="form-control <?php $__errorArgs = ['dateexpircnib'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="dateexpircnib" placeholder=" " name="dateexpircnib" value="<?php echo e(old('dateexpircnib')); ?>" required>
                        <?php $__errorArgs = ['dateexpircnib'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder=" " name="passeport" value="<?php echo e(old('passeport')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control <?php $__errorArgs = ['carteconsulaire'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="carteconsulaire" placeholder=" " name="carteconsulaire" value="<?php echo e(old('carteconsulaire')); ?>">
                        <?php $__errorArgs = ['carteconsulaire'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control <?php $__errorArgs = ['adressfixeur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="adressfixeur" placeholder=" " name="adressfixeur" value="<?php echo e(old('adressfixeur')); ?>" required>
                        <?php $__errorArgs = ['adressfixeur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control <?php $__errorArgs = ['professionfixeur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="professionfixeur" placeholder=" " name="professionfixeur" value="<?php echo e(old('professionfixeur')); ?>" required>
                        <?php $__errorArgs = ['professionfixeur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control <?php $__errorArgs = ['carteprofessionnel'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="carteprofessionnel" placeholder=" " name="carteprofessionnelfixeur" value="<?php echo e(old('carteprofessionnelfixeur')); ?>" required>
                        <?php $__errorArgs = ['carteprofessionnelfixeur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input class="form-control <?php $__errorArgs = ['organe'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="organe" type="text" name="organe" value="<?php echo e(old('organe')); ?>" required />
                        <?php $__errorArgs = ['organe'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input class="form-control <?php $__errorArgs = ['telorgane'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="telorgane" type="text" name="telorgane" value="<?php echo e(old('telorgane')); ?>" required />
                        <?php $__errorArgs = ['telorgane'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input class="form-control <?php $__errorArgs = ['adressestruct'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="adressestruct" type="text" name="adressestruct" value="<?php echo e(old('adressestruct')); ?>" required />
                        <?php $__errorArgs = ['adressestruct'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
