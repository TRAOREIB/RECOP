...
<?php endif; ?>
<p></p>
<form class="col-sm-12" method="post" action="<?php echo e(route("objet.store")); ?>" enctype="multipart/form-data">
                ...
                <div id="panneau1" class="col-sm-6">  
                    <div class="card">
                        ...
                        <div class="row form-group">
                            ...
                            <label class="label" style="margin-left: 0px;color: red"><b>&nbsp;*</b></label>
                            <input class="form-control col-sm-6" type='text' value="<?php echo e(old('libelle')); ?>" name="nom" style="margin-left: 10px" >
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <input class="col-sm-6 form-control" type='text' value="" name="description" style="margin-left: 10px">
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <input class="col-sm-6 form-control" type='text' value="" name="grpethnique" style="margin-left: 10px">
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <input class="col-sm-6 form-control" type='text' value="" name="usage" style="margin-left: 10px">
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <label class="label" style="margin-left: 0px;color: red"><b>&nbsp;*</b></label>
                            <input class="col-sm-6 form-control" type='text' value="" name="localisation" style="margin-left: 10px">
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <input class="col-sm-7 form-control" type='textarea' value="" name="observation" style="margin-left: 10px">
                        </div>
...
<!--                                <label class="label" style="margin-left: 20px">Autre Musée Proprietaire</label>-->
                    ...
                    <div class="card col-sm-12" style="">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" style="margin-left: 65px">
                                ...
                                <div>
                                    <input type="number" step="0.01" min="0" name="poids" class="form-control offset-1 col-sm-10">
                                </div>
                                <label class="label">poids</label>
                            </div>
                            <p>
            ...
            <div class="card col-sm-8" style="">
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-left: 35px">
                        ...
                        <div>
                            <input type="number" step="0.01" min="0" name="taille" class="form-control offset-1 col-sm-10">
                        </div>
                    ...
                    <div class="row" style="margin-left: 3px">
                        ...
                        <div>
                            <input type="number" step="0.01" min="0" name="longueur" class="form-control offset-1 col-sm-10">
                        </div>
                        <label class="label">mètre</label>
                    </div> 
                    <p>
                    <div class="row" style="margin-left: 3px">
                        ...
                        <div>
                            <input type="number" step="0.01" min="0" name="largeur" class="form-control offset-1 col-sm-10">
                        </div>
                    ...
                    <div class="row" style="margin-left: 12px">
                        ...
                        <div>
                            <input type="number" step="0.01" min="0" name="hauteur" class="form-control offset-1 col-sm-10">
                        </div>
                        <label class="label">mètre</label>
                    </div> 
                    <p>
                    <div class="row">
                        ...
                        <div>
                            <input type="number" step="0.01" min="0" name="profondeur" class="form-control offset-1 col-sm-10">
                        </div>
                        <label class="label">mètre</label>
                    ...
                    <div class="row" style="margin-left: 2px">
                        ...
                        <div>
                            <input type="number" step="0.01" min="0" name="diametre" class="form-control offset-1 col-sm-10">
                        </div>
                    ...
                    <div class="row" style="margin-left: 3px">
                        ...
                        <div>
                            <input type="number" step="0.01" min="0" name="epaisseur" class="form-control offset-1 col-sm-10">
                        </div>
                        <label class="label"> mètre</label>
                    </div> 
    ...
    <input type="submit"  value="Ajouter" class="btn btn-primary btn-sm offset-sm-7" style="margin-top: 10px"> 
</form>
<form method="GET" action="<?php echo e(route("objet.index")); ?>">
    <?php echo e(csrf_field()); ?>

    <input type="submit"  value="Annuler" class="btn btn-primary btn-sm offset-sm-6" style="margin-top:-60px"> 
</form>
<p></p>
<!--  fin de la liste-->
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/sygem/resources/views/objet/form_ajout.blade.php ENDPATH**/ ?>