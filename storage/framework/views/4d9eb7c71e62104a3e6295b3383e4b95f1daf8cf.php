...
<form class="form-horizontal col-sm-10 offset-2" role="form" method="POST" action="<?php echo e(route('listeaccreditation')); ?>" enctype="multipart/form-data" >
        ...
        <div class="col-sm-12 ligneform " style="background-color: #EEE">
            <table class="table table-striped table-condensed" id="table">
                ...
                <tbody>
                    ...
                    <tr> 
                        <td><?php echo e($accreditation->idaccreditation); ?></td>
...
<?php echo $__env->make('tprecop.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RECOP\resources\views/accreditation/liste_accreditation.blade.php ENDPATH**/ ?>