        ...
        <div class="tab-pane fade show active" id="home">
            ...
            <div class="row col-sm-12">
                <div class="card col-sm-4">
                    ...
                    <form method="GET" action="<?php echo e(url('getObjetByClassification')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <select id="matiere" name='matiere' class="form-control" >
                                <option selected="selected">Choisir la classification</option>
                                <<?php $__currentLoopData = $listeClassif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idclassification => $classification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($idclassification); ?>"><?php echo e($classification); ?></option>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/sygem/resources/views/search/classification.blade.php ENDPATH**/ ?>