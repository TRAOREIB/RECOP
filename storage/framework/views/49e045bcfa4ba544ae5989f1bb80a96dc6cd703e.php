...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"><?php echo e(__('CREATION DU COMPTE D UTILISATEUR')); ?></div>

                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('creeruser')); ?>">
                        <?php echo csrf_field(); ?>

                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Nom et Prenom')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="profil" class="col-md-4 col-form-label text-md-right"><?php echo e(__("Profil")); ?></label>
...
<?php echo $__env->make('tprecop.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RECOP\resources\views/auth/register.blade.php ENDPATH**/ ?>