...
<form class="form-horizontal col-sm-10 offset-2" role="form" method="POST" action="<?php echo e(route('updatefv',[$editinformation->idinfo])); ?>"  enctype="multipart/form-data" >
...
<?php echo $__env->make('tprecop.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RECOP25\resources\views/information/modif_info_from_vue.blade.php ENDPATH**/ ?>