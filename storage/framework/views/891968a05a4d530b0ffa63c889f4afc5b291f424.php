...
<form method="post" action="<?php echo e(route('nouvcorrespondantpj')); ?>" enctype="multipart/form-data">
        ...
        <div class="card"> <div class=" card text-center card-header">PIECES JOINTES</div>
            <div class="card-body">
                ...
                <div class="form-group row">
                 ...
                 <input type="text" value="<?php echo e($idcorrespondant); ?>" name="idcorrespondant">
            </div>
        </div>
    </div>
...
<?php echo $__env->make('tprecop.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RECOP\resources\views/demandeur/pj_nouveaucorrespondant.blade.php ENDPATH**/ ?>