...
<div class="text-center">
    <label style="font-family: fantasy;color: blue"> LES DEMANDE D'ACCREDITATION POUR VALIDATION</label>
</div>
<hr>
<br>
...
<div class="row offset-1">
    <div class="">
        ...
        <form method="post" action="<?php echo e(route("tousmessage")); ?>">
            <?php echo csrf_field(); ?>
            <input type="submit" value="Voir les messages" class="btn btn-warning">
    ...
    <div>
        <?php $__currentLoopData = $demandeurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form method="post" action="<?php echo e(route("validerdemande")); ?>">
            <?php echo csrf_field(); ?>
    ...
    <div class="">
        <?php $__currentLoopData = $demandeurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form method="post" action="<?php echo e(route("info")); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('tprecop.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RECOP\resources\views/coordonateur/details_accreditation.blade.php ENDPATH**/ ?>