                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row ">
                                        <div>
                                            <form method="post" action="<?php echo e(route('detailsampliateur')); ?>">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <input type="hidden" value="<?php echo e($mesaccredi->valider); ?>" name="valider">
                                                &nbsp;
                                            </form>
                                        </div>
...
<?php echo $__env->make('tprecop.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RECOP\resources\views/ampliateur/liste_demande.blade.php ENDPATH**/ ?>