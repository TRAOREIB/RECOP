    ...
    <div class="card col-sm-6"> 
        ...
        <div class="card-body">
            <label class="col-sm-12 row" style="background-color: #16c7ff">INFO  PERSONNELLES      
                <form method="POST" action="<?php echo e(route('modifdemandeur')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('tprecop.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RECO\resources\views/accreditation/details_accreditation.blade.php ENDPATH**/ ?>