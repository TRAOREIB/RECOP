...
<div class="col-sm-7 offset-3" style="margin-top: 130px">
    <i> <h4 style="margin: 0px; padding-top: 0px; color: #0044cc; font-weight: normal"> Télévision </h4></i>
    ...
    <div class="col-sm-10" style="border:1px solid #D1DCF5;margin-left:0px;padding:15px; margin-left:0px">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class=" row form-group"> 
                    ...
                    <label for="dureearticle1" class="control-label">mn </label>
                    &nbsp;&nbsp;
                    ...
                    &nbsp;&nbsp;<label for="dureearticle1" class="control-label">s </label>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class=" row form-group"> 
                    <label for="dureearticle2" class="control-label col-sm-3">Durée <b><i style="color: red">*</i></b></label> 
                    ...
                    <label for="dureearticle2" class="control-label">mn </label>
                    &nbsp;&nbsp;
                    ...
                    &nbsp;&nbsp;<label for="dureearticle2" class="control-label">s </label>
                </div>
            ...
            echo "<input type='hidden' value='tele' name='macategorie'>";
            ?>
        </div>   
...
<?php echo $__env->make('template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GALIAN\resources\views/candidat/form_mediatelevision.blade.php ENDPATH**/ ?>