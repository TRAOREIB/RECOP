    ...
    <div class="col-sm-12">  <!-- Debut du Bloc -->
        <div class="card"> 
            ...
            <div class="card-body">
                ...
                <input type="text" value="<?php echo e($iddemandeur); ?>" name="iddemandeur">
...
<?php echo $__env->make('tprecop.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RECOP\resources\views/correspondant/nouv_accreditation.blade.php ENDPATH**/ ?>