...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 15 juin 2021 à 14:42
...
INSERT INTO `correspondant` (`idcorrespondant`, `iduser`, `nom`, `prenom`, `datenaissance`, `sexe`, `cnib`, `datedelivcnib`, `dateexpircnib`, `passeport`, `profession`, `telephone`, `telephone2`, `mail`, `lieuresidence`, `numcartepresse`, `refjournal`, `typecorrespondant`, `parcourspro`, `region`, `origine`, `personneprevenir`, `telephonepersp`, `pjcartepresse`, `pjpasseport`, `organe`, `telorgane`, `adresseorgane`, `typepresse`, `actif`, `CREATED_AT`, `UPDATED_AT`) VALUES
(185, 170, 'TOURE', 'Arnaud', NULL, NULL, '78521478', NULL, NULL, '74102036', 'Journaliste', 70203024, NULL, 'tourealidou20501789@yahoo.fr', 'Burkina Faso', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '70203041', NULL, NULL, NULL, 1, '2021-06-12 11:03:16', '2021-06-12 11:03:16'),
(186, 171, 'TOURE', 'Arnaud', NULL, NULL, '78521478', NULL, NULL, '74102036', 'Journaliste', 70203024, NULL, 'tourealidou205017899@yahoo.fr', 'Burkina Faso', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '70203041', NULL, NULL, NULL, 0, '2021-06-12 11:04:45', '2021-06-12 11:04:45'),
(187, NULL, 'SAMBARE', 'Alidou', NULL, NULL, '78456321', NULL, NULL, '78453698', 'Journaliste', 70203024, 74125874, 'sambare12@yahoo.fr', 'Bobo Dioulasso', 7894562, 'Ref', 'Correspondant national', 'Parc', 'Centre', NULL, NULL, NULL, NULL, NULL, 'RFI', NULL, NULL, 'Presse Ecrite', 1, '2021-06-12 11:17:43', '2021-06-12 11:17:43'),
(188, 173, 'DIALLO', 'Sita', NULL, NULL, '74589632', NULL, NULL, '78453698', 'Journaliste', 70203024, 74258796, 'sita@yahoo.fr', 'Bobo Dioulasso', 5456, 'ref', 'Correspondant national', 'parcours', 'Centre', NULL, NULL, NULL, NULL, NULL, 'Radio Omega', NULL, NULL, 'Presse Ecrite', 1, '2021-06-12 11:38:51', '2021-06-12 11:38:51'),
(189, 174, 'MILLOGO', 'Ramata', NULL, NULL, '74589632', NULL, NULL, '78453698', 'Journaliste', 70203024, 74258796, 'sita12@yahoo.fr', 'Bobo Dioulasso', 5456, 'ref', 'Correspondant national', 'parcours', 'Nord', NULL, NULL, NULL, NULL, NULL, 'Radio Omega', NULL, NULL, 'Presse Ecrite', 0, '2021-06-12 11:42:49', '2021-06-12 11:42:49'),
(190, 175, 'DAKOUROU', 'Souleymane', NULL, NULL, '74589632', NULL, NULL, '78453698', 'Journaliste', 70203024, 74258796, 'sita123@yahoo.fr', 'Bobo Dioulasso', 5456, 'ref', 'Correspondant national', 'parcours', 'Nord', NULL, NULL, NULL, NULL, NULL, 'Radio Omega', NULL, NULL, 'Presse Ecrite', 0, '2021-06-12 11:45:16', '2021-06-12 11:45:16'),
(191, 176, 'DAKOUROU', 'Souleymane', NULL, NULL, '74589632', NULL, NULL, '78453698', 'Journaliste', 70203024, 74258796, 'sita78@yahoo.fr', 'Bobo Dioulasso', 5456, 'ref', 'Correspondant national', 'parcours', 'Nord', NULL, NULL, NULL, NULL, NULL, 'Radio Omega', NULL, NULL, 'Presse Ecrite', 0, '2021-06-12 11:47:04', '2021-06-12 11:47:05'),
(192, 177, 'DAKOUROU', 'Souleymane', NULL, NULL, '74589632', NULL, NULL, '78453698', 'Journaliste', 70203024, 74258796, 'sita789@yahoo.fr', 'Bobo Dioulasso', 5456, 'ref', 'Correspondant national', 'parcours', 'Nord', NULL, NULL, NULL, NULL, NULL, 'Radio Omega', NULL, NULL, 'Presse Ecrite', 0, '2021-06-12 11:50:21', '2021-06-12 11:50:22'),
(193, 178, 'DAKOUROU', 'Souleymane', NULL, NULL, '74589632', NULL, NULL, '78453698', 'Journaliste', 70203024, 74258796, 'sita7899@yahoo.fr', 'Bobo Dioulasso', 5456, 'ref', 'Correspondant national', 'parcours', 'Nord', NULL, NULL, NULL, NULL, NULL, 'Radio Omega', NULL, NULL, 'Presse Ecrite', 0, '2021-06-12 11:55:39', '2021-06-12 11:55:40'),
(194, 179, 'ZOUARI', 'Malickou', NULL, NULL, '74859632', NULL, NULL, '74102036', 'Journaliste', 78451236, 74125874, 'malickou@yahoo.fr', 'Bobo Dioulasso', 145237, 'ref', 'Correspondant national', 'parc', 'Centre', NULL, NULL, NULL, NULL, NULL, 'RFI', NULL, NULL, 'Presse Ecrite', 0, '2021-06-12 12:02:39', '2021-06-12 12:02:39'),
(195, 180, 'ZOUARI', 'Malickou', NULL, NULL, '74859632', NULL, NULL, '74102036', 'Journaliste', 78451236, 74125874, 'malickou1@yahoo.fr', 'Bobo Dioulasso', 145237, 'ref', 'Correspondant national', 'parc', 'Centre', NULL, NULL, NULL, NULL, NULL, 'RFI', NULL, NULL, 'Presse Ecrite', 0, '2021-06-12 12:05:50', '2021-06-12 12:05:51'),
(196, 181, 'ZOUARI', 'ZOURE', NULL, NULL, '74589632', NULL, NULL, '78453698', 'Journaliste', 70203024, NULL, 'zoumari@yahoo.fr', 'Bobo Dioulasso', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'RFI', NULL, NULL, NULL, 0, '2021-06-12 12:19:06', '2021-06-12 12:19:06'),
(197, 183, 'ZOUARI', 'ZOURE', NULL, NULL, '74589632', NULL, NULL, '78453698', 'Journaliste', 70203024, NULL, 'zoumari1234@yahoo.fr', 'Bobo Dioulasso', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'RFI', NULL, NULL, NULL, 0, '2021-06-12 12:36:14', '2021-06-12 12:36:14'),
(198, 184, 'MADIAGA', 'Aristide', NULL, NULL, '78963214', NULL, NULL, '74102036', 'Journaliste', 70203024, 74125874, 'madiaga@yahoo.fr', 'Bobo Dioulasso', 7894562, 'ref', 'Correspondant national', 'parc', 'Centre', NULL, NULL, NULL, NULL, NULL, 'Radio Omega', NULL, NULL, 'Presse Ecrite', 0, '2021-06-12 12:39:53', '2021-06-12 12:39:53'),
(199, 185, 'TOURE', 'Arnaud', NULL, NULL, 'B78453621', NULL, NULL, '74102036', 'Journaliste', 70203024, 74125874, 'tourila@yahoo.fr', 'Bobo Dioulasso', 4546, 'REF', 'Correspondant national', 'PARC', 'Centre', NULL, NULL, NULL, NULL, NULL, 'RFI', NULL, NULL, 'Presse Ecrite', 1, '2021-06-12 12:48:16', '2021-06-12 12:48:17'),
(200, 186, 'SAMANDOULGOU', 'Alidou', NULL, NULL, '45879632', NULL, NULL, '78453698', 'Journaliste', 74123689, NULL, 'alidou5@yahoo.fr', 'Bobo Dioulasso', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Radio Omega', NULL, NULL, NULL, 1, '2021-06-12 13:00:44', '2021-06-12 13:00:44'),
(201, 187, 'ZOUMBARA', 'Kalilou', NULL, NULL, '78456321', NULL, NULL, '5664564', 'Journaliste', 70203024, NULL, 'souare@yahoo.fr', 'Bobo Dioulasso', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'RFI', NULL, NULL, NULL, 0, '2021-06-12 14:58:19', '2021-06-13 12:04:21'),
(202, 188, 'DIABOUGOU', 'Alimata', NULL, 'HOMME', 'B78456321', NULL, NULL, 'B78541236', 'Journaliste', 70203045, 77859654, 'diabougou@yahoo.fr', 'Bobo Dioulasso', 74185296, 'references', 'Journaliste independant', 'parcours', 'Centre', NULL, NULL, NULL, NULL, NULL, 'France 24', NULL, NULL, 'Presse Ecrite', 1, '2021-06-13 17:34:23', '2021-06-14 05:54:36'),
(203, 189, 'DIABOUGA', 'Pouga', NULL, 'HOMME', '2564564', '2021-06-04', '2021-06-26', '245', 'Journaliste', 70203045, 77859654, 'zoromela@yahoo.fr', 'Bobo Dioulasso', 12454, 'References', 'Correspondant national', 'parcours', 'Centre', NULL, 'Toure Arnaud', 78563214, NULL, NULL, 'France 24', NULL, NULL, 'Presse Ecrite', 1, '2021-06-14 06:01:55', '2021-06-14 18:29:07'),
(204, 190, 'TAMBOULA', 'Cheik Omar', NULL, 'HOMME', '7855236', NULL, NULL, '7455', 'Journaliste', 70203045, NULL, 'tamboula12@yahoo.fr', 'Bobo Dioulasso', NULL, NULL, NULL, NULL, NULL, NULL, 'Toure Arnaud', 70000000, NULL, NULL, 'RFI', NULL, NULL, NULL, 0, '2021-06-14 11:22:28', '2021-06-14 11:32:33'),
(205, 191, 'TAMBOULA', 'Alimata', NULL, 'MASCULIN', '55', '2021-06-16', '2021-06-24', '557', 'Journaliste', 70203045, NULL, 'tatata@yahoo.fr', 'Bobo Dioulasso', NULL, NULL, NULL, NULL, NULL, NULL, 'Toure Arnaud', 75757, NULL, NULL, 'RFI', NULL, NULL, NULL, 0, '2021-06-14 12:12:51', '2021-06-14 12:12:52'),
(206, 192, 'KONATE', 'Arnaud', NULL, 'HOMME', '7855236', '2021-06-23', '2021-06-17', 'B78541236', 'Journaliste', 70203045, 77859654, 'konatelo@yahoo.fr', 'Bobo Dioulasso', 566666, 'REF', 'Correspondant national', 'PARC', 'Centre', NULL, 'Toure Arnaud', 455556, NULL, NULL, 'Sidwaya', '78566', 'Rue 44', 'Radio', 1, '2021-06-15 08:30:26', '2021-06-15 08:30:27'),
(207, 193, 'KONATE', 'Arnaud', '2021-06-15', 'HOMME', '7855236', '2021-06-23', '2021-06-17', 'B78541236', 'Journaliste', 70203045, 77859654, 'konatelo1@yahoo.fr', 'Bobo Dioulasso', 566666, 'REF', 'Correspondant national', 'PARC', 'Centre', NULL, 'Toure Arnaud', 455556, NULL, NULL, 'Sidwaya', '78566', 'Rue 44', 'Radio', 0, '2021-06-15 08:35:52', '2021-06-15 08:35:53'),
(208, 194, 'TAMBOULARE', 'Alphonse', '2021-06-09', 'FEMME', 'B7855226', '2021-06-21', '2021-06-11', '51556', 'Journaliste', 7845125, 7020365, 'tamboulare@yahoo.fr', 'Bobo Dioulasso', 21545, 'REF', 'Journaliste independant', 'PARC', 'Centre', NULL, 'Toure Arnaud', 544525, NULL, NULL, 'RFI', '785236', 'Rue 44', 'Presse Ecrite', 1, '2021-06-15 09:37:23', '2021-06-15 09:37:23');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vueaccrediregion`  AS  select `ar`.`idaccrediregion` AS `idaccrediregion`,`ar`.`idregion` AS `idregion`,`ar`.`idaccreditation` AS `id`,`ar`.`datedebut` AS `datedebut`,`ar`.`datefin` AS `datefin`,`ar`.`lieuevenement` AS `lieuevenement`,`ar`.`actif` AS `actif`,`ar`.`titreevenement` AS `titre`,`ar`.`created_at` AS `created_at`,`r`.`nomregion` AS `nomregion`,`d`.`iddemandeur` AS `iddemandeur`,`d`.`iduser` AS `iduser` from ((((`accrediregion` `ar` join `region` `r`) join `accreditation` `ac`) join `users` `u`) join `demandeur` `d`) where ((`ar`.`idaccreditation` = `ac`.`idaccreditation`) and (`ar`.`idregion` = `r`.`idregion`) and (`d`.`iddemandeur` = `ac`.`iddemandeur`) and (`d`.`iduser` = `u`.`id`) and (`d`.`actif` = 1)) ;
...
--
ALTER TABLE `accrediregion`
  MODIFY `idaccrediregion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;

--
-- AUTO_INCREMENT pour la table `accreditation`
--
ALTER TABLE `accreditation`
  MODIFY `idaccreditation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=142;

--
-- AUTO_INCREMENT pour la table `correspondant`
--
ALTER TABLE `correspondant`
  MODIFY `idcorrespondant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=209;

--
-- AUTO_INCREMENT pour la table `demandeur`
--
ALTER TABLE `demandeur`
  MODIFY `iddemandeur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;
...
--
ALTER TABLE `mediacorrespondant`
  MODIFY `IDMEDIACORRES` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
